...
encoder_op_list_name_dict = {
    ...
    '12x4_ryzxy':
        [
            ...
            {'input_idx': [36], 'func': 'ry', 'wires': [0]},
            {'input_idx': [37], 'func': 'ry', 'wires': [1]},
            {'input_idx': [38], 'func': 'ry', 'wires': [2]},
            {'input_idx': [39], 'func': 'ry', 'wires': [3]},
            {'input_idx': [40], 'func': 'ry', 'wires': [4]},
            {'input_idx': [41], 'func': 'ry', 'wires': [5]},
            {'input_idx': [42], 'func': 'ry', 'wires': [6]},
            {'input_idx': [43], 'func': 'ry', 'wires': [7]},
            {'input_idx': [44], 'func': 'ry', 'wires': [8]},
            {'input_idx': [45], 'func': 'ry', 'wires': [9]},
            {'input_idx': [46], 'func': 'ry', 'wires': [10]},
            {'input_idx': [47], 'func': 'ry', 'wires': [11]}
    ...
    '16x4_ryzxy':
        [
            ...
            {'input_idx': [36], 'func': 'rx', 'wires': [4]},
            {'input_idx': [37], 'func': 'rx', 'wires': [5]},
            {'input_idx': [38], 'func': 'rx', 'wires': [6]},
            {'input_idx': [39], 'func': 'rx', 'wires': [7]},
            {'input_idx': [40], 'func': 'rx', 'wires': [8]},
            {'input_idx': [41], 'func': 'rx', 'wires': [9]},
            {'input_idx': [42], 'func': 'rx', 'wires': [10]},
            {'input_idx': [43], 'func': 'rx', 'wires': [11]},
            {'input_idx': [44], 'func': 'rx', 'wires': [12]},
            {'input_idx': [45], 'func': 'rx', 'wires': [13]},
            {'input_idx': [46], 'func': 'rx', 'wires': [14]},
            {'input_idx': [47], 'func': 'rx', 'wires': [15]},

            {'input_idx': [48], 'func': 'ry', 'wires': [0]},
            {'input_idx': [49], 'func': 'ry', 'wires': [1]},
            {'input_idx': [50], 'func': 'ry', 'wires': [2]},
            {'input_idx': [51], 'func': 'ry', 'wires': [3]},
            {'input_idx': [52], 'func': 'ry', 'wires': [4]},
            {'input_idx': [53], 'func': 'ry', 'wires': [5]},
            {'input_idx': [54], 'func': 'ry', 'wires': [6]},
            {'input_idx': [55], 'func': 'ry', 'wires': [7]},
            {'input_idx': [56], 'func': 'ry', 'wires': [8]},
            {'input_idx': [57], 'func': 'ry', 'wires': [9]},
            {'input_idx': [58], 'func': 'ry', 'wires': [10]},
            {'input_idx': [59], 'func': 'ry', 'wires': [11]},
            {'input_idx': [60], 'func': 'ry', 'wires': [12]},
            {'input_idx': [61], 'func': 'ry', 'wires': [13]},
            {'input_idx': [62], 'func': 'ry', 'wires': [14]},
            {'input_idx': [63], 'func': 'ry', 'wires': [15]}
