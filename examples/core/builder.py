...
def my_dataset() -> Dataset:
    ...
    import numpy as np
    # Load raw data
    train_raw = pd.read_csv(f'examples/data/hidden_manifold/QML_Hidden_80d_train.csv', header=None)
    val_raw = pd.read_csv(f'examples/data/hidden_manifold/QML_Hidden_80d_val.csv', header=None)
    test_raw = pd.read_csv(f'examples/data/hidden_manifold/QML_Hidden_80d_test.csv', header=None)
